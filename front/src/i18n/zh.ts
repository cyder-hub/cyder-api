export const zhDict = {
  ...
  apiKeyPage: {
    title: "API Key 管理",
    description: "集中管理每个 API Key 的身份、ACL、生命周期和运行时治理能力。",
  ...
  modelRoutePage: {
    title: "逻辑模型路由",
    description: "管理共享逻辑模型名、主 candidate 顺序，以及是否暴露到 /models。",
    addRoute: "添加路由",
    loading: "正在加载模型路由...",
  ...
  costPage: {
    title: "成本管理",
    description:
      "先查看成本目录列表，再通过弹窗进入方案编辑，维护版本、组件与成本试算。",
