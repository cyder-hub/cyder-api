...
export const Route = createFileRoute('/_layout/provider/edit/$id')({
    component: ProviderEditPage,
});

function ProviderEditPage() {
    const { id } = Route.useParams()();
    const providerIdNum = parseInt(id, 10);
    return <ProviderEdit providerId={isNaN(providerIdNum) ? null : providerIdNum} />;
}
