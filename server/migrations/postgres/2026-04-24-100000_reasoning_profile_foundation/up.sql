...
ALTER TABLE provider
    ADD COLUMN IF NOT EXISTS default_reasoning_profile_id BIGINT DEFAULT NULL
...
ALTER TABLE model
    ADD COLUMN IF NOT EXISTS reasoning_profile_override_id BIGINT DEFAULT NULL
        REFERENCES reasoning_profile (id)
            ON DELETE SET NULL
            ON UPDATE CASCADE;
...
ADD COLUMN IF NOT EXISTS base_requested_model_name TEXT NULL;

ALTER TABLE request_log
ADD COLUMN IF NOT EXISTS resolved_reasoning_suffix TEXT NULL;

ALTER TABLE request_log
ADD COLUMN IF NOT EXISTS resolved_reasoning_preset TEXT NULL;
