...
(
    id            BIGINT PRIMARY KEY NOT NULL,               -- Unique identifier for the provider (generated by Snowflake algorithm).
...
(
    id          BIGINT PRIMARY KEY NOT NULL,               -- Unique identifier for the API key record (generated by Snowflake algorithm).
...
CREATE TABLE IF NOT EXISTS billing_plans (
    id BIGINT PRIMARY KEY NOT NULL,                      -- Plan ID: A unique identifier.
    ...
    is_default BOOLEAN NOT NULL DEFAULT false,  -- If true, this plan is the default for new models.
...
(
    id              BIGINT PRIMARY KEY NOT NULL,               -- Unique identifier for the model record (generated by Snowflake algorithm).
...
CREATE TABLE IF NOT EXISTS access_control_policy (
    id BIGINT PRIMARY KEY NOT NULL,                        -- Unique identifier for the access control policy (Snowflake ID).
...
CREATE TABLE IF NOT EXISTS access_control_rule (
    id BIGINT PRIMARY KEY NOT NULL,                        -- Unique identifier for the access control rule (Snowflake ID).
...
(
    id                BIGINT PRIMARY KEY NOT NULL,               -- Unique identifier for the system API key (Snowflake ID).
    ...
    usage_limit_policy_id    BIGINT DEFAULT NULL,     -- Optional foreign key to 'usage_limit_policy' table.
...
CREATE TABLE IF NOT EXISTS custom_field_definition (
    id BIGINT PRIMARY KEY NOT NULL,                      -- 定义的唯一标识符 (雪花ID)。
...
CREATE TABLE IF NOT EXISTS request_log (
    id BIGINT PRIMARY KEY NOT NULL,                          -- Unique identifier for the request log entry (Snowflake ID).
...
CREATE TABLE IF NOT EXISTS model_alias (
    id BIGINT PRIMARY KEY NOT NULL,                          -- Unique identifier for the model alias (Snowflake ID).
